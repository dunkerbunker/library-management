    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                        <form action="{{ url('admin/borrowers') }}" method="POST">
                            @csrf
                            
                            <div class="form-group mb-3">
                                <label for="name">Borrower's Name</label>
                                <input type="text" class="form-control" id="borrower_name" name="borrower_name" placeholder="Enter the Borrower's Name">
                                <span class="text-danger">@error('borrower_name'){{ $message }} @enderror</span>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">IC</label>
                                <input type="text" class="form-control" id="IC" name="IC" placeholder="Enter the Borrower's IC">
                                <span class="text-danger">@error('IC'){{ $message }} @enderror</span>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">Phone Number</label>
                                <input type="text" class="form-control" id="phone_no" name="phone_no" placeholder="Enter the Borrower's Phone Number">
                                <span class="text-danger">@error('phone_no'){{ $message }} @enderror</span>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">Address</label>
                                <textarea type="text" class="form-control" id="address" name="address" placeholder="Enter the Borrower's Address" rows="3"></textarea>
