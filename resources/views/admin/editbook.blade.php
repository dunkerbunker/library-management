                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/book-details/'.$book->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="year" name="year" placeholder="Enter Year" value="{{ $book->year }}">
                                <span class="text-danger">@error('year'){{ $message }} @enderror</span>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">Book Title</label>
                                <input type="text" class="form-control" id="book_title" name="book_title" placeholder="Enter Book Title" value="{{ $book->book_title }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="publisher_name" name="publisher_name" placeholder="Enter Publisher Name" value="{{ $book->publisher_name }}">
