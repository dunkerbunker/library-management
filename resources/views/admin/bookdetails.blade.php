                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col col-sm-3 col-xs-12">
                            <h4 class="title p-0 mb-3">Books <span>List</span></h4>
                            <a href="{{ url('admin/book-details/create') }}" id="add" class="btn btn.sm btn-primary">Add Book</a>
                        </div>

                        <div class="col-sm-9 col-xs-12 text-right">
                                <form class="" type="get" action="">
                                    <div class="btn_group d-flex flew-row align-items-center justify-content-start">
                                        <input class="form-control" style="margin-right: 1rem;" type="search" name="search" placeholder="Search Books By Name, ISBN, Author" value="{{$search}}"> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="d-inline-flex action-list align-items-center">
                                        <li><a href="{{ url('admin/book-details/'.$book->id.'/edit') }}" data-tip="edit"><i class="fa fa-edit"></i></a></li>
                                        <li>
                                            <form action="{{ url('admin/book-details/'.$book->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
