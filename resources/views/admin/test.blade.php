                ...
                <div class="panel-heading">
                    ...
                    <div class="row">
                        <div class="col col-sm-3 col-xs-12">
                            <h4 class="title p-0 mb-3">Borrowers <span>List</span></h4>
                        ...
                        <div class="col-sm-9 col-xs-12 text-right">
                                <form class="" type="get" action="">
                                    <div class="btn_group d-flex flew-row align-items-center justify-content-start">
                                        <input class="form-control" type="search" name="search" placeholder="Search Borrowers By Name" value="{{$search}}"> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="d-inline-flex action-list align-items-center">
                                        <li><a href="{{ url('admin/borrowers/'.$borrower->id.'/edit') }}" data-tip="edit"><i class="fa fa-edit"></i></a></li>
                                        <li>
                                            <form action="{{ url('admin/borrowers/'.$borrower->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn trash"><i class="fa fa-trash"></i></button>
                                            </form>
                                        </li>
                                    </ul>
                                </td>
                                <td class="d-flex justify-content-center align-items-center" style="height: 70px;">
                                    <a href="" class="btn btn-outline-success my-2 rounded-pill">View Books</a>                               
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
